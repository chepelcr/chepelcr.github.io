...
const translations = {
  es: {
    ...
    "projects.aiTitle": "Microservicio de Inteligencia Artificial",
    "projects.aiDesc": "Servicio de procesamiento de datos con algoritmos de ML",
  ...
  en: {
    ...
    "projects.aiTitle": "Artificial Intelligence Microservice",
    "projects.aiDesc": "Data processing service with ML algorithms",
    "projects.ecommerceTitle": "E-commerce API",
